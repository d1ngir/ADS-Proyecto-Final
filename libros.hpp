...
namespace biblioteca
{
    ...
    class Cliente : public Usuario
    {
        ...
        public:
            Cliente();
            Cliente(string folio, string nombre, string prestamoc, string reservac, string multac);
    ...
    class ListaCl 
    {
        ...
        public:
            ...
            void eliminar(int indiceCl);
            vector <string> getListaCl();        
            string listaCl();                        
            Cliente& getCliente(int numCl);          
    };
    ...
    class ListaTr 
    {
        ...
        public:
            ...
            int size();                       
            void agregar(Trabajador trabajadores);  
            void eliminar(int indiceTr);
            vector <string> getListaTr();        
            string listaTr();                        
            Trabajador& getTrabajador(int numTr);          
    };
}
